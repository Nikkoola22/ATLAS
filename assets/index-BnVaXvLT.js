 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(C,k){var R=C.length;C.push(k);e:for(;0<R;){var $=R-1>>>1,K=C[$];if(0<i(K,k))C[$]=k,C[R]=K,R=$;else break e}}function n(C){return C.length===0?null:C[0]}function r(C){if(C.length===0)return null;var k=C[0],R=C.pop();if(R!==k){C[0]=R;e:for(var $=0,K=C.length,er=K>>>1;$<er;){var ht=2*($+1)-1,Ei=C[ht],yt=ht+1,tr=C[yt];if(0>i(Ei,R))yt<K&&0>i(tr,Ei)?(C[$]=tr,C[yt]=R,$=yt):(C[$]=Ei,C[ht]=R,$=ht);else if(yt<K&&0>i(tr,R))C[$]=tr,C[yt]=R,$=yt;else break e}}return k}function i(C,k){var R=C.sortIndex-k.sortIndex;return R!==0?R:C.id-k.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;e.unstable_now=function(){return s.now()}}else{var a=Date,o=a.now();e.unstable_now=function(){return a.now()-o}}var l=[],c=[],g=1,h=null,v=3,x=!1,E=!1,L=!1,T=typeof setTimeout=="function"?setTimeout:null,d=typeof clearTimeout=="function"?clearTimeout:null,u=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function p(C){for(var k=n(c);k!==null;){if(k.callback===null)r(c);else if(k.startTime<=C)r(c),k.sortIndex=k.expirationTime,t(l,k);else break;k=n(c)}}function f(C){if(L=!1,p(C),!E)if(n(l)!==null)E=!0,yi(j);else{var k=n(c);k!==null&&xi(f,k.startTime-C)}}function j(C,k){E=!1,L&&(L=!1,d(A),A=-1),x=!0;var R=v;try{for(p(k),h=n(l);h!==null&&(!(h.expirationTime>k)||C&&!Z());){var $=h.callback;if(typeof $=="function"){h.callback=null,v=h.priorityLevel;var K=$(h.expirationTime<=k);k=e.unstable_now(),typeof K=="function"?h.callback=K:h===n(l)&&r(l),p(k)}else r(l);h=n(l)}if(h!==null)var er=!0;else{var ht=n(c);ht!==null&&xi(f,ht.startTime-k),er=!1}return er}finally{h=null,v=R,x=!1}}var w=!1,N=null,A=-1,M=5,P=-1;function Z(){return!(e.unstable_now()-P<M)}function un(){if(N!==null){var C=e.unstable_now();P=C;var k=!0;try{k=N(!0,C)}finally{k?dn():(w=!1,N=null)}}else w=!1}var dn;if(typeof u=="function")dn=function(){u(un)};else if(typeof MessageChannel<"u"){var Oa=new MessageChannel,od=Oa.port2;Oa.port1.onmessage=un,dn=function(){od.postMessage(null)}}else dn=function(){T(un,0)};function yi(C){N=C,w||(w=!0,dn())}function xi(C,k){A=T(function(){C(e.unstable_now())},k)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(C){C.callback=null},e.unstable_continueExecution=function(){E||x||(E=!0,yi(j))},e.unstable_forceFrameRate=function(C){0>C||125<C?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):M=0<C?Math.floor(1e3/C):5},e.unstable_getCurrentPriorityLevel=function(){return v},e.unstable_getFirstCallbackNode=function(){return n(l)},e.unstable_next=function(C){switch(v){case 1:case 2:case 3:var k=3;break;default:k=v}var R=v;v=k;try{return C()}finally{v=R}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(C,k){switch(C){case 1:case 2:case 3:case 4:case 5:break;default:C=3}var R=v;v=C;try{return k()}finally{v=R}},e.unstable_scheduleCallback=function(C,k,R){var $=e.unstable_now();switch(typeof R=="object"&&R!==null?(R=R.delay,R=typeof R=="number"&&0<R?$+R:$):R=$,C){case 1:var K=-1;break;case 2:K=250;break;case 5:K=1073741823;break;case 4:K=1e4;break;default:K=5e3}return K=R+K,C={id:g++,callback:k,priorityLevel:C,startTime:R,expirationTime:K,sortIndex:-1},R>$?(C.sortIndex=R,t(c,C),n(l)===null&&C===n(c)&&(L?(d(A),A=-1):L=!0,xi(f,R-$))):(C.sortIndex=K,t(l,C),E||x||(E=!0,yi(j))),C},e.unstable_shouldYield=Z,e.unstable_wrapCallback=function(C){var k=v;return function(){var R=v;v=k;try{return C.apply(this,arguments)}finally{v=R}}}})(ol);al.exports=ol;var Pd=al.exports;/**
 * @license React
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const bp=e=>e.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase().trim(),je=(e,t)=>{const n=b.forwardRef(({color:r="currentColor",size:i=24,strokeWidth:s=2,absoluteStrokeWidth:a,className:o="",children:l,...c},g)=>b.createElement("svg",{ref:g,...qp,width:i,height:i,stroke:r,strokeWidth:a?Number(s)*24/Number(i):s,className:["lucide",`lucide-${bp(e)}`,o].join(" "),...c},[...t.map(([h,v])=>b.createElement(h,v)),...Array.isArray(l)?l:[l]]));return n.displayName=`${e}`,n};/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
`):"Aucun chapitre spécifique trouvé. Thèmes : "+Wi.chapitres.map(s=>s.titre).join(", ")},am=()=>{const[e,t]=b.useState(null),[n,r]=b.useState(!1),[i,s]=b.useState(0),[a,o]=b.useState(0),[l,c]=b.useState(1),[g,h]=b.useState(!0),[v,x]=b.useState(!1),[E,L]=b.useState(null),T=b.useRef(null);b.useEffect(()=>{const f=T.current;if(!f)return;r(!1),s(0),o(0),L(null),x(!1);const M={timeupdate:()=>s(f.currentTime||0),loadedmetadata:()=>{f.duration&&isFinite(f.duration)&&o(f.duration)},canplay:()=>x(!1),ended:()=>{r(!1);const P=xr.findIndex(Z=>Z.id===(e==null?void 0:e.id));P!==-1&&P<xr.length-1&&t(xr[P+1])},error:()=>{x(!1),r(!1),L("Impossible de charger ce podcast. Vérifiez votre connexion.")},loadstart:()=>x(!0),waiting:()=>x(!0),playing:()=>{x(!1),r(!0)},pause:()=>r(!1)};return Object.entries(M).forEach(([P,Z])=>f.addEventListener(P,Z)),f.volume=l,e&&f.load(),()=>{Object.entries(M).forEach(([P,Z])=>f.removeEventListener(P,Z))}},[e,l]);const d=async()=>{const f=T.current;if(!(!f||!e))try{n?f.pause():(x(!0),L(null),await f.play())}catch(j){console.error("Error playing audio:",j),L("Impossible de lire ce podcast."),x(!1),r(!1)}},u=f=>{(e==null?void 0:e.id)!==f.id&&(t(f),r(!1))},p=f=>{if(!f||isNaN(f))return"0:00";const j=Math.floor(f/60),w=Math.floor(f%60).toString().padStart(2,"0");return`${j}:${w}`};return m.jsx("div",{className:`fixed right-4 bottom-4 z-50 transition-all duration-300 ${g?"w-60 h-14":"w-80 h-auto"}`,children:m.jsxs("div",{className:"flex flex-col bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 rounded-xl shadow-lg border border-purple-500/30 overflow-hidden p-2",children:[m.jsxs("div",{className:"flex items-center justify-between gap-2",children:[m.jsx("button",{onClick:()=>h(!g),className:"text-white p-1.5 hover:bg-white/10 rounded-full",children:g?"🔼":"🔽"}),e&&m.jsx("button",{onClick:d,className:"bg-purple-600 hover:bg-purple-700 text-white rounded-full p-2",children:n?m.jsx(Vp,{className:"w-5 h-5"}):m.jsx(Hp,{className:"w-5 h-5"})}),m.jsxs("div",{className:"flex-grow flex items-center gap-2",children:[m.jsx(Qp,{className:"w-5 h-5 text-gray-300"}),m.jsx("input",{type:"range",min:"0",max:"1",step:"0.01",value:l,onChange:f=>c(parseFloat(f.target.value)),className:"w-full h-1 bg-purple-300 rounded slider appearance-none"})]})]}),m.jsx("audio",{ref:T,src:e==null?void 0:e.url,preload:"metadata",style:{display:"none"},crossOrigin:"anonymous"}),!g&&m.jsxs("div",{className:"mt-4",children:[m.jsxs("div",{className:"flex flex-col items-center mb-4",children:[m.jsx("img",{src:"./podcast.jpg",alt:"Illustration Podcast",className:"w-32 h-32 object-cover rounded-full shadow-md border-2 border-purple-400"}),m.jsx("h4",{className:"text-white font-bold text-center mt-2",children:"Épisodes disponibles"})]}),m.jsx("ul",{className:"max-h-48 overflow-y-auto",children:xr.map(f=>m.jsx("li",{children:m.jsx("button",{onClick:()=>u(f),className:`block w-full text-left px-3 py-2 rounded-md text-sm text-white mb-1 transition-colors ${(e==null?void 0:e.id)===f.id?"bg-purple-700 font-semibold":"bg-purple-800/60 hover:bg-purple-700/80"}`,children:f.title})},f.id))}),e&&m.jsxs("div",{className:"mt-2 px-2 text-xs text-purple-200",children:[m.jsxs("p",{className:"truncate",children:["Lecture : ",e.title]}),m.jsx("div",{children:m.jsxs("span",{children:[p(i)," / ",p(a)]})}),E&&m.jsx("div",{className:"text-red-300 mt-1",children:E})]})]})]})})};function om(){const[e,t]=b.useState({currentView:"menu",selectedDomain:null,messages:[],isProcessing:!1}),[n,r]=b.useState(""),[i,s]=b.useState(null),a=b.useRef(null),o=b.useRef(null),l=b.useRef(null);b.useEffect(()=>{var T;(T=a.current)==null||T.scrollIntoView({behavior:"smooth"})},[e.messages]);const c=()=>{setTimeout(()=>{var T;(T=l.current)==null||T.scrollIntoView({behavior:"smooth",block:"start"})},100)},g=T=>{t({currentView:"chat",selectedDomain:T,messages:[{type:"assistant",content:{0:"Bonjour ! Je peux vous aider avec vos questions sur les horaires, congés, ARTT, temps partiel, heures supplémentaires, absences, etc.",1:"Bonjour ! Je peux vous renseigner sur le CPF, les congés de formation, la VAE, les concours, les bilans de compétences, etc. Quelle est votre question ?",2:"Bonjour ! Je suis l'assistant spécialiste du télétravail. Posez-moi vos questions sur la charte, les jours autorisés, les indemnités, etc."}[T],timestamp:new Date}],isProcessing:!1}),c(),setTimeout(()=>{var u;return(u=o.current)==null?void 0:u.focus()},150)},h=()=>{t({currentView:"menu",selectedDomain:null,messages:[],isProcessing:!1}),r(""),s(null)},v=async T=>{const d=await fetch(Zp,{method:"POST",headers:{Authorization:`Bearer ${Yp}`,"Content-Type":"application/json"},body:JSON.stringify({model:"llama-3-sonar-large-32k-online",messages:T})});if(!d.ok){const p=await d.text();throw console.error("Détail de l'erreur API:",p),new Error(`Erreur API (${d.status})`)}return(await d.json()).choices[0].message.content},x=async T=>{let d="";e.selectedDomain===0?d=sm(T):e.selectedDomain===1?d=JSON.stringify(Kp,null,2):e.selectedDomain===2&&(d=Xp);const u=`
